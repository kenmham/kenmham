...
[**Atomic-LLM**](https://github.com/kenmham/Atomic-LLM) — Linearly verifiable code generation for LLMs. AST-level purity enforcement, retry loop, concurrent atom generation.

[**SmallC**](https://github.com/kenmham/SmallC) — A small compiler for C, written in C.
...
<sub>Currently: DSI Summer Lab @ UChicago · writing about AGI ontology · building in public</sub>
